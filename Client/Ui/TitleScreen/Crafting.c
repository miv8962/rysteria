...
{
    for (uint8_t id = 1; id <= rr_petal_id_amethyst_leaf; ++id)
    {
        uint32_t sum = 0;
                                 ...
                                 struct rr_game *game)
{
    ...
    if (!can_craft(game))
        rr_ui_set_background(this, 0xff999999);
    else
                                                ...
                                                struct rr_game *game)
{
    ...
    rr_system_particle_render_tick(game, &game->crafting_particle_manager,
                                   game->lerp_delta);
    rr_renderer_context_state_init(renderer, &state);
...
static struct rr_ui_element *crafting_button_init()
{
    ...
    this->animate = craft_button_animate;
                                     ...
                                     struct rr_game *game)
{
    ...
    case rr_rarity_id_ultimate:
        data->text = "5b xp per craft";
        break;
    case rr_rarity_id_quantum:
        data->text = "10b xp per craft";
        break;
    case rr_rarity_id_aurous:
        data->text = "24b xp per craft";
        break;
    case rr_rarity_id_eternal:
        data->text = "90b xp per craft";
        break;
    case rr_rarity_id_hyper:
        data->text = "130b xp per craft";
        break;
    case rr_rarity_id_sunshine:
        data->text = "250b xp per craft";
        break;
    case rr_rarity_id_nebula:
        data->text = "700b xp per craft";
        break;
